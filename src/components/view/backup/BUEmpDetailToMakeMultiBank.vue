<!-- Bản Backup trước khi vẽ lại dialog để đổi sang nhiều ngân hàng (01/11/2021 10:26am) -->
<template>
    <div class="dialog">
            ...
            if(this.formmode == form.add) {
                return axios
                    ...
                    .catch((res) => {
                        ...
                        if(errorContent.includes(MsgFromServer.EmployeeCode)) this.isValid.employeeCode = false;
                        if(errorContent.includes(MsgFromServer.Phone)) this.isValid.phone = false;
                        if(errorContent.includes(MsgFromServer.TelePhone)) this.isValid.telephone = false;
                        if(errorContent.includes(MsgFromServer.Email)) this.isValid.email = false;

            ...
            <div class="right-content">
                ...
                <div class="right-content-content">
                    <div class="title-dialog">
                        <div style="font-size: 20px; margin: 10px 0px 0px 0px;"><b>Thành công</b></div>
                    </div>
                    <div class="header">
                        <!-- <button class="btn-warning btn-warning-dc"></button> -->
                        <div style="margin-top: 5px;">{{warningMsg}}</div>
                    </div>
                </div>
    ...
    .right-content{
        ...
        .right-content-img{
            ...
            .img-content{
                ...
                background-image: url('../../../assets/Icons/ic_ToastMessage_Success.png');
            }
